...
class FT_Portfolios_Slide extends Widget_Base
{


    public function get_name()
    {
        return 'ft-portfolios-slide';
    }


    public function get_title()
    {
        return __('FT Portfolios Slide', 'rifa-core');
    }
    ...
    protected function render()
    {
        ...
        <script>
            jQuery(document).ready(function($) {
                var swiper = new Swiper(".portfolios_swiper", {
...
$widgets_manager->register(new FT_Portfolios_Slide());
