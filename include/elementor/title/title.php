 ...
 * @since 1.0.0
 */
class FT_Title extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'     => [
                    '{{WRAPPER}} .ft-title' => 'text-align: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ft-title:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .ft-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .ft-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
    ...
    protected function render()
    {
        ...
        <?php if ($settings['style'] == 'style_one') : ?>
                ...
                <?php if (!empty($settings['title'])) :   ?>
                    <h4 class="ft-title "><?php echo wp_kses($settings['title'], wp_kses_allowed_html('post'))  ?></h4>
                <?php endif ?>
...
$widgets_manager->register(new FT_Title());
