...
class FT_Portfolios_Post extends Widget_Base
{


    public function get_name()
    {
        return 'ft-portfolios-post';
    }


    public function get_title()
    {
        return __('FT Portfolios Post', 'rifa-core');
    }
...
$widgets_manager->register(new FT_Portfolios_Post());
