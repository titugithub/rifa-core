...
class FT_OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'ft_ocdi_rewrite_flush'] );
    }

    public function import_files_config() {

		$home_prevs = array(
			'ft_demo_home_1' => array(
				'title' => __( 'Home 1', 'rifa-core' ),
				'page'  => __( 'home', 'rifa-core' ),
    ...
    public function ft_ocdi_rewrite_flush() {
