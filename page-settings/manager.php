...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'rifa-core' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'rifa-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'rifa-core' ),
			]
		);
